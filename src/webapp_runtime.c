/*
 * webapp_runtime.c - Sandboxed per-webapp Wasmer runtime implementation: per-instance bindings (no globals), offscreen WGPU, dashboard-IPC instead of direct SDL.
