/*
 * damage_tracker.h - Per-slot dirty/damage tracking for the dashboard compositor so static UI doesn't burn GPU work calling guest frame exports every tick.
