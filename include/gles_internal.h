/*
 * gles_internal.h - Private helpers for the WebGL2 → WebGPU emulation layer: arg-extraction macros, memory access helpers, and fn_* callback forward declarations.
