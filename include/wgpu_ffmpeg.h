/*
 * wgpu_ffmpeg.h - Zero-copy bridge between FFmpeg hardware-decoded frames and WebGPU (VAAPI/DMA-BUF on Linux, IOSurface on macOS, DXGI shared handles on Windows).
