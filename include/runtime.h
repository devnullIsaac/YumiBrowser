/*
 * runtime.h - Wasmer-based WASM runtime that loads guest modules and dispatches SDL input events (keyboard/mouse/touch/joystick/gamepad/window) to WASM callbacks.
