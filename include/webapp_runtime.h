/*
 * webapp_runtime.h - Sandboxed per-webapp Wasmer runtime: offscreen WGPU, per-webapp DuckDB, font/text shaping, video/image decode; no SDL window or filesystem access.
