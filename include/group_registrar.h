/*
 * group_registrar.h - Public Group Registrar API: post-quantum identity, group lifecycle, peers, roles, epochs, invites, join verification, audit log, delta sync, behavioral analysis.
