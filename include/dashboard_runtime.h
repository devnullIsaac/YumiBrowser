/*
 * dashboard_runtime.h - Dashboard supervisor runtime: owns the SDL window, tiles webapp surfaces, mediates clipboard, controls group lifecycle, friends, recovery, export.
