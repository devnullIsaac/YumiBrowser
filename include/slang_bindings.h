/*
 * slang_bindings.h - Slang shader compiler WASM bindings exposing global sessions, compilation sessions, modules, entry points, linking, codegen, and full reflection.
